...
<head>
	...
	<meta name="keywords" content="eppdb v.1.1, ppdb madrasah, ppdb sekolah, web smanka," />
...
<body data-spy="scroll" data-target="#menu" data-offset="100">
	<div class="home-wrapper" id="home">
				...
				<nav class="navbar navbar-expand-lg navbar-light" id="navbar-header">
					<a class="navbar-brand" href="javascript:;">
						...
						<div class="home-header-text d-none d-sm-block">
							...
							<h6><strong><?= strtoupper($setting['nama_sekolah']) ?></strong></h6>
							<h6>Tahun 2022</h6>
						</div>
		...
		<?php if ($akhir <= $awal) { ?>
			...
			<script src="vendor/unbk/jquery/jquery-3.2.1.min.js"></script>
			<script src="vendor/unbk/jquery/jquery.form.min.js"></script>
			<script src="vendor/unbk/bootstrap-4/js/bootstrap.min.js"></script>
			<script src="vendor/unbk/bootstrap-4/js/popper.min.js"></script>
			<script src="vendor/unbk/wow/js/wow.min.js"></script>
			<script src="vendor/unbk/chart/Chart.min.js"></script>
